...
#define CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_MASK UINT32_C(0x000F0000)
#define CPUINFO_LOONGARCH_CPUCFG_PART_MASK         UINT32_C(0x0000FFF0)
#define CPUINFO_LOONGARCH_CPUCFG_REVISION_MASK     UINT32_C(0x0000000F)

#define CPUINFO_LOONGARCH_CPUCFG_IMPLEMENTER_OFFSET  24
#define CPUINFO_LOONGARCH_CPUCFG_VARIANT_OFFSET      20
#define CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_OFFSET 16
#define CPUINFO_LOONGARCH_CPUCFG_PART_OFFSET          4
...
inline static uint32_t cpucfg_set_architecture(uint32_t cpucfg, uint32_t architecture) {
	return (cpucfg & ~CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_MASK) |
		((architecture << CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_OFFSET) & CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_MASK);
}
...
inline static uint32_t cpucfg_copy_architecture(uint32_t cpucfg, uint32_t other_cpucfg) {
	return (cpucfg & ~CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_MASK) | (other_cpucfg & CPUINFO_LOONGARCH_CPUCFG_ARCHITECTURE_MASK);
}
