...
#define CPUINFO_LOONGARCH_LINUX_VALID_SUFFIX UINT32_C(0x00010000)
#define CPUINFO_LOONGARCH_LINUX_VALID_IMPLEMENTER  UINT32_C(0x00020000)
#define CPUINFO_LOONGARCH_LINUX_VALID_VARIANT      UINT32_C(0x00040000)
#define CPUINFO_LOONGARCH_LINUX_VALID_PART         UINT32_C(0x00080000)
#define CPUINFO_LOONGARCH_LINUX_VALID_REVISION     UINT32_C(0x00100000)
